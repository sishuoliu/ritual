...
class GameSimulator:
    ...
    def run_batch(self, num_games: int) -> Dict:
        ...
        return {
            ...
            "liberation_rate": liberation_wins/num_games*100,
            "standard_rate": standard_wins/num_games*100
        }
...
def main():
    ...
    # Save results
    with open("batch_simulation_results.json", "w", encoding="utf-8") as f:
        json.dump(all_results, f, ensure_ascii=False, indent=2)
    
    # Print summary
    print("\n" + "="*70)
    print("BATCH SIMULATION RESULTS - Path to Salvation v2.2")
    print("="*70)
    ...
    for size in test_sizes:
        ...
        print(f"\n[Victory Types]")
        print(f"  Liberation/Nirvana: {r['liberation_rate']:5.1f}%")
        print(f"  Standard:           {r['standard_rate']:5.1f}%")
    
    print("\n" + "="*70)
    print("Results saved to batch_simulation_results.json")
